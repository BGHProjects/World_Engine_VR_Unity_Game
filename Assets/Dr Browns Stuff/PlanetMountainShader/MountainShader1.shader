Shader "Custom/MountainShader1"
{
    ...
    SubShader 
	{
  		...
  		{ 
			...
			{
				VSOutput Output;
				float g_fDispFactor = 0.3f;	// displacement factor
				...
				else if (displaceVal > 0.35)
				{
					displacePos = a_Input.pos + a_Input.norm * displaceVal * g_fDispFactor;
					//Dark Brown
					Output.col = float3(0.28,0.18,0.09);
				}
				else if (displaceVal > 0.2)
				{
					displacePos = a_Input.pos + a_Input.norm * displaceVal * g_fDispFactor;
					//Light green
					Output.col = float3(0.0, 0.3, 0.0);
				}
				else if (displaceVal > 0.105)
				{
					displacePos = a_Input.pos + a_Input.norm * displaceVal * g_fDispFactor;
					//Light green
				...
				{
					displacePos = a_Input.pos + a_Input.norm * 0.1 * g_fDispFactor;
					//displacePos = a_Input.pos + a_Input.norm * displaceVal * g_fDispFactor;
